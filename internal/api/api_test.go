...
func TestTraceOutlineEndpointSerializesProbeLaserTrace(t *testing.T) {
	...
	want := []string{
		...
		"G90 G1 X10.0000 Y0.0000 F600.0000",
	}
	got := m.Gcodes()
	if len(got) != len(want) {
